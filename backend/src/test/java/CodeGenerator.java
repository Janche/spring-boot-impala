...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:impala://192.168.0.20:21050/default";
...
//        genCodeByCustomModelNameAndTemplate("user", "user", "User","simpleDict"); // 调用simpleDict的模板
        genCodeByCustomModelNameAndTemplate("spring-boot-impala", "log", "CrashLog","simpleDict"); // 调用simpleDict的模板
